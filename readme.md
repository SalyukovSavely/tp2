...
https://t.me/tp_2_ss_bot - бот в телеграмме, который отправляет статус пройденных тестов
* Test past sucsess - тесты успешны
* This test failed: Test№ - ошибка при тестировании
